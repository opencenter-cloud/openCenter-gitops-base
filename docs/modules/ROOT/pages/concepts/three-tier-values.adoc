...
. *Base values* in `openCenter-gitops-base`
. *Override values* in the consuming cluster repository
. *Enterprise values* in the private enterprise repository, when used
