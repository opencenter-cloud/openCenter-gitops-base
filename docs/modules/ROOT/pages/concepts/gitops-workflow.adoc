...
| exports reusable base service paths and base values

| `opencenter-gitops-enterprise`
| imports base paths and applies enterprise-specific patches, sources, and values

| Cluster overlay repo
| defines Flux source and install objects, cluster-local overrides, secrets, and extra manifests
|===
