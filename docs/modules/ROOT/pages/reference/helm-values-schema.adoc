...
This page focuses on how those sources appear in manifests. For the ownership model and rationale, use xref:../concepts/three-tier-values.adoc[Base, Override, and Enterprise Values].
