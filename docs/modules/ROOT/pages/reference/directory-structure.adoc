...
* xref:../concepts/architecture.adoc[Architecture Explanation]
...
. Keep the base repo upstream-backed and reusable.
. Keep service directories independently renderable where practical.
. Split multi-stage services when deployment order matters.
. Keep cluster-specific and enterprise-specific deltas outside this repo.

== References

* xref:operations/services/index.adoc[Service Reference Library]
