...
* https://github.com/kubernetes/cloud-provider-openstack/tree/master/docs[Cloud Provider OpenStack docs]
* https://github.com/kubernetes/cloud-provider-openstack/tree/master/charts/openstack-cloud-controller-manager[OpenStack CCM chart docs]
