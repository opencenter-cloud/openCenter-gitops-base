...
* xref:../../operations/services/metallb.adoc[MetalLB Configuration Guide]

== Upstream References

* https://metallb.universe.tf/[MetalLB docs]
* https://metallb.universe.tf/configuration/[MetalLB configuration guide]
* https://artifacthub.io/packages/helm/metallb/metallb[MetalLB Helm chart]
