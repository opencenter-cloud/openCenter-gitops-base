...
. *Intake Request:* [Service-specific intake requirements]
. *Architecture Review:* [Architecture considerations specific to this service]
. *Prototype in Dev:* [Development requirements and deliverables]
. *Operational Review:* [Operational validation requirements]
. *Stage Decision:* [Decision criteria and approval process]
...
| Incubating
| [Service-specific entry criteria]
| [Service-specific exit criteria]
