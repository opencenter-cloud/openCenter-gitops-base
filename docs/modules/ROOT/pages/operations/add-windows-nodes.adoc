...
| ""
| string
| Glance image ID for Windows Server
...
| "Administrator"
| string
| Admin user for Windows Server

| windows_admin_password
| ""
| String
| Password for Admin user of Windows Server

| worker_node_bfv_size_windows
| 0
| number
| Volume Size of root disk for Windows Server

| worker_node_bfv_type_windows
| "local"
| string
| Volume type. Can be either "local" or "volume"
|===
