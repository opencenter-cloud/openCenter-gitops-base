...
* Configure observability (see xref:operations/setup-observability.adoc[setup-observability.adoc])
* Add Gateway API routing (see xref:operations/configure-gateway.adoc[configure-gateway.adoc])
...
* link:../../applications/base/services/cert-manager/[Cert-manager Base Service] - Reference Helm-based service structure
