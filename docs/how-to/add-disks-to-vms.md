---
id: add-disks-to-vms
title: "Add Disks to Virtual Machines"
sidebar_label: Add Disks
description: Steps to add additional disks to Kubernetes worker node VMs using OpenTofu and Kubespray.
doc_type: how-to
...
```
module "openstack-nova" {
  source                          = "github.com/opencenter-cloud/openCenter-gitops-base.git//iac/cloud/openstack/openstack-nova?ref=multi-disk1"
