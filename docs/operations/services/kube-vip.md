...
description: How to configure Kube-VIP for highly available Kubernetes API endpoints in openCenter cluster builds.
doc_type: how-to
...
module "kubespray-cluster" {
  source = "github.com/opencenter-cloud/openCenter-gitops-base.git//iac/provider/kubespray?ref=<release/branch>"
